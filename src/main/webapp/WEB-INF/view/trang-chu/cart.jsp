                                ...
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        <div class="d-flex justify-content-between align-items-center mb-5">
                                            ...
                                            <h6 class="mb-0 text-muted">${cart.size()} sản phẩm</h6>
                                        </div>
                                        <hr class="my-4">
                                        <c:forEach items="${cart}" var="x">
                                            <c:forEach items="${lstTK}" var="y">
                                                <c:if test="${x.key == y.id}">
                                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                            ...
                                                            <input id="form1" min="0" name="soLuong" value="${x.value}"
                                                                   type="number"
                                                        ...
                                                        <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                            <h6 class="mb-0">${x.value * y.donGia} VNĐ</h6>
                                                        </div>
