...
<body>
<form id="suck" method="post" enctype="multipart/form-data" class="container">
    ...
    <div class="row">
        <div class="col-6">
            <form name="findByName">
                <div class="row">
                    <label for="findByName" class="form-label">Tìm kiếm theo tên:</label>
                    <div class="col-10">
                        <input type="text" class="form-control" id="findByName" name="findByName"
